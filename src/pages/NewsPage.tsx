...
const newsItems = [
  {
    date: '10 апреля 2026',
    title: 'Форсайт-экспертиза',
    lead: 'Сегодня на Форсайт экспертизе мы презентуем наши продукты ♥️',
    image: '/87dce663-4fd7-4031-b89b-2b83d79b9664.jpg',
    content: [],
  },
  {
    date: '27 марта 2026',
  ...
  },
  {
    ...
    content: [
      '«Создание экотроп: от идеи до реализации».',
      '«Виртуальные экотропы: технологии для современного обучения».',
      '«Экологическое воспитание через проектное обучение».',
      '«Интерактивные элементы на экотропах: привлекаем внимание учеников».',
      '«Сотрудничество с местным сообществом: создание экотроп вместе».',
    ],
  },
];
