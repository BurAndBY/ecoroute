...
const stationSixAppendixD = {
  ...
  itemTitle: '1. Береза повислая (Betula)',
  details: [
    'Семейство: Березовые',
    'Тип растения: древесное',
    'Отношение к свету: светолюбивое',
...
const stationNineOverview = {
  intro:
    'Пройдя до конца березовой аллеи, попадаем на каштановую аллею. Доминирующим видом является каштан конский. Деревья высажены вдоль дороги и выполняют шумозащитную и пылезащитную функцию. Рядом располагаются кустарники: кизильник, бирючина, дерен, сумах, снежноягодник белый (Приложение Ж).',
  ...
  barberryText:
    'Барбарис обыкновенный (Berberis vulgaris) — листопадный кустарник до 2,5-3 м высотой. Цветки мелкие, желтые, с приятным медовым ароматом, собраны в поникающие кисти до 6 см. Цветет в мае 2-3 недели. Плоды декоративны и съедобны.',
  thunbergText:
    'Барбарис Тунберга (Berberis thunbergii) — кустарник до 2,5 м с дугообразными ребристыми ветвями. Листья мелкие, осенью ярко-красные. Цветки желтые, ягоды кораллово-красные, блестящие. Цветет в мае, плодоносит в сентябре-октябре.',
  images: {
...
const stationTenAppendixI = {
  ...
  brunnera: [
    'Бруннера, незабудочник (Brunnera)',
